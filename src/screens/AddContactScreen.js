    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.inputsContentContainer}>
          <Text style={styles.enterEmailText}>Contact toevoegen</Text>
          ...
          <View style={styles.searchInputMainContainer}>
            <AuthInput placeholder="Naam" value={name} setValue={setName} />
          </View>
          ...
          <View style={styles.searchInputMainContainer}>
            <AuthInput placeholder="E-mail" value={email} setValue={setemail} />
          </View>
